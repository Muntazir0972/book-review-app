            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title',$book->title) }}" name="title" id="title" />
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        @if (!empty($book->image))
                        <img class="w-25 my-3" src="{{ asset('uploads/books/'.$book->image) }}" alt="">
