        ...
        <div class="col-md-12">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    ...
                    @if ($book->image != '')
                    <img src="{{ asset('uploads/books/'.$book->image) }}" alt="" class="card-img-top"></a>
                    @else
                ...
                <div class="col-md-8">
                    ...
                    <div class="star-rating d-inline-flex ml-2" title="">
                        <span class="rating-text theme-font theme-yellow">{{ number_format($avgRating) }}</span>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4 col-lg-4 mb-4">
                            <div class="card border-0 shadow-lg">
                                ...
                                <img src="{{ asset('uploads/books/'.$relatedBook->image) }}" alt=""
