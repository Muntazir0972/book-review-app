                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                @csrf
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" id="confirm_password" value="" placeholder="Confirm Password" >
